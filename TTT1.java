...
TTT1(){
super("tic tac toe by rohan and harshit");
...
ic1=new ImageIcon("ci11.png");
ic2=new ImageIcon("ci12.png");
ic11=new ImageIcon("ci1.png");
ic22=new ImageIcon("ci2.png");
  ...
  Icon icon3=b[(a[i][3]-1)].getIcon();
	...
	JOptionPane.showMessageDialog(TTT1.this,"!!!YOU won!!! click reset");			 break;
             ...
             b[(a[i][3]-1)].setIcon(ic22);
               JOptionPane.showMessageDialog(TTT1.this,"!!! NOOOO (COMPUTER) won!!! click reset");
                break;
               }
         }
    }
